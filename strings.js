...
// repeat
lists[15].innerText = `Repeat 'fox' 4x: ${'fox'.repeat (4)}`
lists[16].innerHTML = `Repeat 'quick' 4x: ${note.slice(note.indexOf('q'),note.indexOf('k')+1).replace}`


// include
lists[17].innerHTML = `Does our note contact fox: ${note.includes('fox')}`
...
// endsWith
lists[20].innerText = `Does it end with 'e':${note.startsWith('e')}`